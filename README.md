...
- [Dataset Details](#dataset-details)
  - [Annotations in Video-Descriptions](#annotations-in-video-descriptions)
    - [Annotations Format](#annotations-format)
  - [Actions Annotations from Video](#actions-annotations-from-video)
  - [Actions Annotations from VD](#actions-annotations-from-vd)
    - [Alignment Strategies](#alignment-strategies)
    - [Reference Gold Samples](#reference-gold-samples)
- [Metadata File Contents](#metadata-file-contents)
- [Visualization Tool](#visualization-tool)
- [Contributors and Acknowledgement](#contributors-and-acknowledgement)
- [References](#references)
  - [Fr-VD: Dataset and Visualization Tool](#fr-vd-dataset-and-visualization-tool)
  - [Additional Bibliographical References](#additional-bibliographical-references)
...
This step represents the stratégies that were employed to obtain a mapping between actions defined on the
text domain (obtained from [VD annotations](#actions-annotations-from-vd)) and the video domain
(obtained from [video inferences](#actions-annotations-from-video)).
...
The tool provided in [crim-ca/FrVD-visualization-tool][viewer-tool] repository can be employed for synchronized
visualization of metadata annotation files of this [FrVD][FrVD] dataset and videos of movies/TV shows.
